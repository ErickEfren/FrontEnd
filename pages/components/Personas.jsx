...
export default function Boleto() {
  ...
  return (
      <div className="flex flex-col px-16 pt-5 pb-8 text-3xl text-black whitespace-nowrap bg-orange-100 rounded-3xl max-w-[487px] max-md:px-5">
      <Grid rows="1" columns="2">
        <Box align="center">
          <div className="flex flex-col my-auto">
            <div className="mt-5">Completo</div>
            <div className="mt-8">INAPAM</div>
            <div className="mt-8">Medio</div>
            <div className="mt-8 max-md:mt-10">Profesor</div>
          </div>
        </Box>
        <Box>
        <Counter
