...
export default function MyComponent() {
  return (
    <div className="flex justify-center items-center px-16 py-20 text-black bg-orange-100 max-md:px-5">
      <div className="flex overflow-hidden relative flex-col justify-center items-center px-16 py-20 max-w-full fill-[linear-gradient(180deg,#F1D112_0%,#FAFF00_100%)] min-h-[592px] w-[825px] max-md:px-5">
        <img
          loading="lazy"
        ...
        <div className="flex relative flex-col mt-48 mb-5 max-w-full w-[498px] max-md:mt-10">
          ...
          <div className="flex flex-col justify-center self-center mt-28 max-w-full text-3xl whitespace-nowrap bg-yellow-400 border border-black border-solid rounded-[100px] w-[223px] max-md:mt-10">
